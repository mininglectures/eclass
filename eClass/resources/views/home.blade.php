                        ...
                        <div class="view-block">
                            <div class="view-img">
                                @if($enrol->courses['preview_image'] !== NULL && $enrol->courses['preview_image'] !== '')
                                    <a href="{{url('show/coursecontent',$enrol->courses->id)}}"><img src="{{ asset('images/course/'.$enrol->courses['preview_image']) }}" alt="course" class="img-fluid"></a>
                                @else
                                    <a href="{{url('show/coursecontent',$enrol->courses->id)}}"><img src="{{ Avatar::create($enrol->courses->title)->toBase64() }}" alt="course" class="img-fluid"></a>
                                @endif
                            </div>
                            <div class="view-dtl">
                                <div class="view-heading btm-10"><a href="{{url('show/coursecontent',$enrol->courses->id)}}">{{ str_limit($enrol->courses->title, $limit = 30, $end = '...') }}</a></div>
                                <p class="btm-10"><a herf="#">{{ __('frontstaticword.by') }} {{ $enrol->courses->user['fname'] }}</a></p>
                                <div class="rating">
                                    <ul>
                                        <li>
                                            <?php 
                    ...
                    <div class="genre-slide-image protip" data-pt-placement="outside" data-pt-interactive="false" data-pt-title="#prime-next-item-description-block-3{{$bundle->id}}">
                        <div class="view-block">
                            ...
                            <div class="view-dtl">
                                ...
                                <p class="btm-10"><a herf="#">{{ __('frontstaticword.by') }} {{ $bundle->user['fname'] }}</a></p>
